...
export default function EnhancedSolutionSection() {
  ...
  return (
    <div ref={sectionRef} className="py-20 bg-white relative">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {problemSolutions.map((item, index) => (
              ...
              >
                <div className="bg-white rounded-xl p-8 border border-gray-200 transition-all duration-300 group-hover:shadow-lg group-hover:border-emerald-200">
                  <div className="mb-6">
                    <div className="w-12 h-12 bg-gray-50 rounded-lg flex items-center justify-center mb-4 group-hover:bg-emerald-50 transition-colors duration-300">
                      <item.icon className="w-6 h-6 text-gray-500 group-hover:text-emerald-600 transition-colors duration-300" />
                    </div>
                    
                    <div className="mb-1">
                      <span className={`text-xs font-semibold uppercase tracking-wide ${hoveredCard === index ? item.solutionColor : item.problemColor}`}>
                  ...
                  <div className="bg-gray-50 group-hover:bg-emerald-50/50 rounded-lg p-4 transition-colors duration-300">
        ...
        <div className="bg-slate-900 rounded-xl p-10 md:p-14 text-white mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {techSpecs.map((spec, index) => (
              <div key={index} className="bg-white/5 rounded-xl p-8 border border-white/10 hover:border-emerald-500/30 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          <div className="bg-red-50 rounded-xl p-10 border border-red-100">
            ...
            <div className="space-y-3">
              {["Unbearable heat, no cooling", "16+ hours daily without power", "Children can't study after dark", "High electricity bills, food spoilage"].map((item, i) => (
                <div key={i} className="flex items-center bg-white p-4 rounded-lg border border-red-100">
          ...
          <div className="bg-emerald-50 rounded-xl p-10 border border-emerald-100">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
            ...
            <div className="space-y-3">
              {["Cool, comfortable homes 24/7", "Reliable power day and night", "Children thrive with evening study", "Zero electricity bills, fresh food"].map((item, i) => (
                <div key={i} className="flex items-center bg-white p-4 rounded-lg border border-emerald-100">
        ...
        <div className="bg-emerald-900 rounded-xl p-12 md:p-16 text-white text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            <div className="flex items-center bg-white/10 px-6 py-3 rounded-lg border border-white/10">
