    ...
    <main role="main">
      ...
      <article className="sr-only">
        ...
        <section>
          <h3>Our Impact</h3>
          <p>
            We have successfully installed 24 solar panels, empowering 23 families and transforming
            240 lives across Pakistan. Our installations prevent 1,900 kg of CO₂ emissions, equivalent to planting 95 trees.
          </p>
        </section>
    ...
    <section className="sr-only" itemScope itemType="https://schema.org/FAQPage">
      ...
      <div itemScope itemType="https://schema.org/Question">
        ...
        <div itemScope itemType="https://schema.org/Answer" itemProp="acceptedAnswer">
          <div itemProp="text">
            We have successfully installed 24 solar panels, empowering 23 families and transforming
            240 lives. Our installations prevent 1,900 kg of CO₂ emissions, contributing to both social and environmental impact.
          </div>
        </div>
      </div>
