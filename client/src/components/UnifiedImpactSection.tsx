  ...
  return (
    <div ref={sectionRef} className="py-20 bg-gradient-to-b from-blue-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="bg-gradient-to-br from-red-600 via-orange-600 to-red-700 rounded-3xl p-8 text-white relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              <div className="inline-flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full mb-4">
              ...
              <h3 className="text-4xl font-bold mb-4 bg-gradient-to-r from-white to-red-100 bg-clip-text text-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <div className="text-4xl font-bold">{stats?.temperature || 45}°C</div>
                    <div className="text-sm opacity-90">Extreme Heat</div>
                  </div>
                </div>
                <p className="text-sm opacity-80">Temperatures regularly exceed 45°C, making life unbearable without cooling</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <div className="text-4xl font-bold">{stats?.hoursWithoutPower || 16}h</div>
                    <div className="text-sm opacity-90">Power Outages</div>
                  </div>
                </div>
                <p className="text-sm opacity-80">Daily blackouts leave families without fans, lights, or refrigeration</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-sm opacity-80">Millions of Pakistani families struggle with unreliable electricity daily</p>
              </div>
            </div>

            <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 border border-white/30 text-center">
              <h4 className="text-2xl font-bold mb-3">Every Donation Creates Hope</h4>
              <p className="text-lg opacity-95 max-w-3xl mx-auto leading-relaxed">
                While we celebrate our progress, millions of Pakistani families still endure scorching heat without reliable power. 
