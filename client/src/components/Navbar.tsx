    ...
    <header className="sticky top-0 z-50 bg-white shadow-lg border-b border-green-200">
      <div className="mx-auto max-w-7xl px-4 py-3 md:px-8 lg:px-12 md:py-4 lg:py-5">
        <div className="flex items-center justify-between">
          ...
          {/* Main Navigation */}
          <nav className="hidden md:flex items-center space-x-6 lg:space-x-8 xl:space-x-10 ml-8 lg:ml-12">
          ...
          {/* Action Buttons */}
          <div className="hidden md:flex items-center space-x-3 lg:space-x-4 xl:space-x-6 ml-auto">
            <Link 
              href="/worker/login" 
