  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 overflow-x-hidden">
      ...
      <main ref={mainRef} className="relative w-full">
        ...
        {/* Interactive Crisis Statistics Section */}
        <section className="min-h-screen bg-white relative overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto px-6">
              
              {/* Extreme Heat Card */}
              <div className="group relative bg-gradient-to-br from-red-50 to-orange-50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-red-100">
                <div className="absolute -top-4 -right-4 w-8 h-8 bg-red-400 rounded-full animate-pulse"></div>
                <div className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-red-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6">
                    <ThermometerSun className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-red-800 mb-4">Extreme Heat</h3>
                  <div className="text-5xl font-bold text-red-600 mb-2">35°C+</div>
                  <p className="text-red-700 text-lg font-medium mb-4">Average Temperature</p>
                  <p className="text-gray-700 leading-relaxed">
                    Unbearable heat makes life difficult without proper cooling systems. Families suffer in sweltering conditions.
                  </p>
                </div>
              </div>

              {/* Daily Blackouts Card */}
              <div className="group relative bg-gradient-to-br from-gray-50 to-slate-50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-200">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Daily Blackouts</h3>
                  <div className="text-5xl font-bold text-gray-700 mb-2">12 hrs</div>
                  <p className="text-gray-600 text-lg font-medium mb-4">Without Power Daily</p>
                  <p className="text-gray-700 leading-relaxed">
                    Extended power outages disrupt education, work, and basic daily activities for millions of families.
                  </p>
                </div>
              </div>

              {/* People Affected Card */}
              <div className="group relative bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-blue-100">
                <div className="absolute -top-4 -right-4 w-8 h-8 bg-blue-400 rounded-full animate-pulse"></div>
                <div className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-6">
                    <Users className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-blue-800 mb-4">People Affected</h3>
                  <div className="text-5xl font-bold text-blue-600 mb-2">210M+</div>
                  <p className="text-blue-700 text-lg font-medium mb-4">Pakistanis Impacted</p>
                  <p className="text-gray-700 leading-relaxed">
                    The vast majority of Pakistan's population faces these energy challenges every single day.
                  </p>
                </div>
              </div>
          ...
          <div className="absolute top-20 left-20 w-32 h-32 bg-red-200/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-32 right-32 w-40 h-40 bg-blue-200/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-gray-200/20 rounded-full blur-3xl animate-pulse delay-500"></div>
          
          {/* Continue scrolling prompt */}
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
            <button 
              onClick={() => document.getElementById('solution')?.scrollIntoView({ behavior: 'smooth' })}
              className="group flex flex-col items-center animate-bounce"
            >
              <span className="text-gray-600 text-sm font-medium mb-2 group-hover:text-gray-800 transition-colors">
        ...
        {/* Crisis Section - Traditional section for additional context */}
